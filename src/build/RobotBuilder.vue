<template>
  <div>
    ...
    <div class="middle-row">
      <div class="left part">
        <img v-bind:src="availableParts.arms[selectLeftArmIndex].src" title="leftarm"/>
      ...
      <div class="right part">
        <img v-bind:src="availableParts.arms[selectRightArmIndex].src" title="rightarm"/>
    ...
    <div class="bottom-row">
      <div class="bottom part">
        <img v-bind:src="availableParts.bases[selectBaseIndex].src" title="base"/>
